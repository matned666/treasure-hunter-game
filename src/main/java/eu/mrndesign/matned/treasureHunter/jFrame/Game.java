...
import eu.mrndesign.matned.treasureHunter.fileOperations.FileOperations;
import eu.mrndesign.matned.treasureHunter.gameMechanics.Field;
import eu.mrndesign.matned.treasureHunter.gameMechanics.MazeMatrix;
...
public class Game {
    ...
    private static final String MAZE_HUNTER_TITLE = "Maze hunter";
    private static final String LETS_GO_MSG = "Lets go";
    private static final String FILE_NOT_FOUND_MSG = " File not found ";
    private static final String TREASURE_INFO_LABEL = " Treasure:";
    private static final String HP_INFO_LABEL = "HP:";
    private static final String GAME_INFO_LABEL = " Game:";
    private static final String LEVEL_INFO_LABEL = "  level:";
    private static final String YOUR_TREASURE_INFO_LABEL = " Your Treasure:";
    private static final String HP_SEPARATOR_INFO_LABEL = "/";
    private static final String CONTINUE_BUTTON_TEXT = "CONTINUE";
    private static final String GAME_OVER_MSG = "GAME OVER";
    private static final String LEVEL_INFO_MSG = "LEVEL:";
    private static final String ID_DONE_MSG = " ID DONE";
    private static final String FONT = "Comic Sans MS";
    private static final String GAME_OVER_JPG = "gameOver.jpg";
    private static final String WIN_LEVEL_JPG = "winLevel.jpg";
    ...
    private void initialize( int monsters, int treasures ) {
        ...
        frame = new JFrame();
        frame.setTitle(MAZE_HUNTER_TITLE);
    ...
    private void setGameInfo(){
        gameInfo.setText(HP_INFO_LABEL + myMaze.getPlayer().getHP()+ TREASURE_INFO_LABEL + myMaze.getPlayer().getCollectedTreasuresInLevel()+
                HP_SEPARATOR_INFO_LABEL +myMaze.getNUMBER_OF_TREASURES()+ GAME_INFO_LABEL +gameState+ LEVEL_INFO_LABEL +levelNumber+
                YOUR_TREASURE_INFO_LABEL +totallyCollectedTreasures);
    }
    ...
    private void endGameWindowFrameAcceptButton(){
        ...
        confirmationButton.setText(CONTINUE_BUTTON_TEXT);
    ...
    private void endGameWindowFrameMessageLabel(){
        ...
        if(gameState == GameState.GAME_OVER) messageLabel.setText(GAME_OVER_MSG);
        else if(gameState == GameState.WIN) messageLabel.setText(LEVEL_INFO_MSG +levelNumber+ ID_DONE_MSG);
        messageLabel.setVerticalAlignment(SwingConstants.CENTER);
        messageLabel.setHorizontalAlignment(SwingConstants.CENTER);
        dialogWithWinOrLoseMessage.add(messageLabel);
        messageLabel.setFont(new Font(FONT, Font.BOLD, 32));
    }

    private void endGameWindowFrameImageLabel(){
        JLabel labelWithImage = new JLabel();
        labelWithImage.setBounds(270,70,50,50);
        if(gameState==GameState.GAME_OVER) labelWithImage.setIcon(new ImageIcon(RESOURCE_PATH + GAME_OVER_JPG));
        if(gameState==GameState.WIN) labelWithImage.setIcon(new ImageIcon(RESOURCE_PATH + WIN_LEVEL_JPG));
